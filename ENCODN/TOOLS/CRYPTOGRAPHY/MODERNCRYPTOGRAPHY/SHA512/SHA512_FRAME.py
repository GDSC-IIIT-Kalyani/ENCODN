...
from .SHA512 import encrypt, decrypt

def SHA512_FRAME(master=None):
	...
	ttk.Label(lf1, text="SHA-512 Hash").grid(row=2, columnspan=2, padx=20, pady=20, sticky="nsew")
	...
	ttk.Label(lf2, text="SHA-512 Hash").grid(row=14,column=0, columnspan=2, padx=20, pady=20, sticky="nsew")
