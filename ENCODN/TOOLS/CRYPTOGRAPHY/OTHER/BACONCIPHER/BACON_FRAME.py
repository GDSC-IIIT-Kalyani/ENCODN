...
from .BACON import encrypt, decrypt

def BACON_FRAME(master=None):
	...
	ttk.Label(lf1, text="Bacon Cypher").grid(row=2, columnspan=2, padx=20, pady=20, sticky="nsew")
	...
	ttk.Label(lf2, text="Bacon Cypher").grid(row=14,column=0, columnspan=2, padx=20, pady=20, sticky="nsew")
